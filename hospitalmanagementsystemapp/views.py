...
from hospitalmanagementsystemapp.cridentials import MpesaAccessToken

from django.shortcuts import render, redirect
from hospitalmanagementsystemapp.models import Member, Contact, Users, ImageModel
from hospitalmanagementsystemapp.forms import ImageUploadForm
...
def stk(request):
    if request.method == "POST":
        ...
        request = {'BusinessShortCode': LipanaMpesaPpassword.Business_short_code,
                   'Password': LipanaMpesaPpassword.decode_password, 'Timestamp': LipanaMpesaPpassword.lipa_time,
                   ...
                   'CallBackURL': "https://sandbox.safaricom.co.ke/mpesa/", 'AccountReference': "Apen Softwares",
